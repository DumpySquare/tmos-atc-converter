...
describe('AS3 Classic Converter: AS3 Classic Converter: Monitor MYSQL: ltm monitor mysql', () => {
    it('monitor_mysql', async () => {
        const json = await as3ConvHelper.convertConfigFiles(`${__dirname}/monitor_mysql.conf`);
        ...
        return as3ConvHelper.compareAndValidate(
            json,
            await miscUtils.loadJSON(`${__dirname}/monitor_mysql.json`)
        );
    });
});
