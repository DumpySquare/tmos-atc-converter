...
const validator = require('./validators/as3ClassicAdapter');

module.exports = {
    /**
     * Compare and validate AS3 Classic data
     *
     * @param {object} actual
    ...
    async convertConfigFiles(...files) {
        ...
        return (await as3Converter(parsed, {})).declaration;
    },
