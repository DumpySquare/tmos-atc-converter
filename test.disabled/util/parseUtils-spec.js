...
const arrToMultilineStr = require('../../src/utils/parse/arrToMultilineStr');
const countIndent = require('../../src/utils/parse/countIndent');
const getTitle = require('../../src/utils/parse/getTitle');
const objToArr = require('../../src/utils/parse/objToArr');
const removeIndent = require('../../src/utils/parse/removeIndent');
const strToObj = require('../../src/utils/parse/strToObj');
...
"`
    ...
    describe('getTitle', () => {
        it('should return the object title', () => {
            ...
            assert.deepStrictEqual(output, 'ltm profile tcp /AS3_Tenant/AS3_Application/testItem');
        });
    });
